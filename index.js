...
function showReport(){
    ...
    reportBtn.style.borderColor = '#222';
...
function showSettings() {
    ...
    settingsBtn.style.borderColor = '#222';
...
function signUpFormFunc(){
    ...
    localStorage.setItem("allUsers", JSON.stringify(allUsersObj));
    setTimeout(() => {
        let showAlert = document.getElementById("successAlert");
        let data = `<div class="alert alert-success" role="alert">
  This is a success alert—check it out!
</div>`
showAlert.innerHTML = data ;
    }, 3000);
